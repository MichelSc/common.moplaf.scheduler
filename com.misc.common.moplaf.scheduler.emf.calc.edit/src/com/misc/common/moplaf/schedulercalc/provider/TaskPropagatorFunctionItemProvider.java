...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.schedulercalc.TaskPropagatorFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskPropagatorFunctionItemProvider extends PropagatorFunctionBindingsItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskPropagatorFunctionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskPropagatorFunction_Task_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskPropagatorFunction_Task_feature", "_UI_TaskPropagatorFunction_type"),
				 SchedulerCalcPackage.Literals.TASK_PROPAGATOR_FUNCTION__TASK,
				 false,
				 false,
				 false,
				 null,
