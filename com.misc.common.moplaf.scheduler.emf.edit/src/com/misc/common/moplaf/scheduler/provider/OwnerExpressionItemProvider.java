...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.scheduler.OwnerExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OwnerExpressionItemProvider 
	 ...
	 * @generated
	 */
	public OwnerExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((OwnerExpression)object).getOwner();
		return label == null || label.length() == 0 ?
			getString("_UI_OwnerExpression_type") :
			getString("_UI_OwnerExpression_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OwnerExpression.class)) {
