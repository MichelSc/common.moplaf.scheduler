...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.scheduler.SolutionPropagatorFunction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionPropagatorFunctionItemProvider extends PropagatorFunctionBindingsItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SchedulerPackage.Literals.SOLUTION_PROPAGATOR_FUNCTION__SOLUTION,
				 false,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		String label = ((SolutionPropagatorFunction)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_SolutionPropagatorFunction_type") :
			getString("_UI_SolutionPropagatorFunction_type") + " " + label;
	}
