...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.scheduler.CalcSolutionExpressionCandidateValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalcSolutionExpressionCandidateValueItemProvider extends SolutionExpressionPropagatorFunctionItemProvider {
	...
	public String getText(Object object) {
		String label = ((CalcSolutionExpressionCandidateValue)object).getDescription();
		return label == null || label.length() == 0 ?
			getString("_UI_CalcSolutionExpressionCandidateValue_type") :
			getString("_UI_CalcSolutionExpressionCandidateValue_type") + " " + label;
	}
