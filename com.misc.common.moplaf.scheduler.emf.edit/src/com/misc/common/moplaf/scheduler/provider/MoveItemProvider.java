...
/**
 * This is the item provider adapter for a {@link com.misc.common.moplaf.scheduler.Move} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MoveItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Move_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Move_Name_feature", "_UI_Move_type"),
				 SchedulerPackage.Literals.MOVE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulerPackage.Literals.MOVE__EXPRESSIONS);
			childrenFeatures.add(SchedulerPackage.Literals.MOVE__CHANGES);
		}
