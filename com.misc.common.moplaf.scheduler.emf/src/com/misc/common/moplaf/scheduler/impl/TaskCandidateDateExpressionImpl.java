...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Task Candidate Date Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.scheduler.impl.TaskCandidateDateExpressionImpl#getTask <em>Task</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskCandidateDateExpressionImpl extends CandidateDateExpressionImpl implements TaskCandidateDateExpression {
	 ...
	 * @generated
	 */
	protected TaskCandidateDateExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.TASK_CANDIDATE_DATE_EXPRESSION;
	}
	...
	public NotificationChain basicSetTask(SolutionTask newTask, NotificationChain msgs) {
		...
		task = newTask;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SchedulerPackage.TASK_CANDIDATE_DATE_EXPRESSION__TASK, oldTask, newTask);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TaskExpression.class) {
			switch (derivedFeatureID) {
				case SchedulerPackage.TASK_CANDIDATE_DATE_EXPRESSION__TASK: return SchedulerPackage.TASK_EXPRESSION__TASK;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TaskExpression.class) {
			switch (baseFeatureID) {
				case SchedulerPackage.TASK_EXPRESSION__TASK: return SchedulerPackage.TASK_CANDIDATE_DATE_EXPRESSION__TASK;
				default: return -1;
			}
		}
...
} //TaskCandidateDateExpressionImpl
