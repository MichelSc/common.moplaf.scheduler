 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.scheduler.impl.ResetSolutionExpressionCandidateValueImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResetSolutionExpressionCandidateValueImpl extends PropagatorFunctionBindingsImpl implements ResetSolutionExpressionCandidateValue {
	/**
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.RESET_SOLUTION_EXPRESSION_CANDIDATE_VALUE;
	}
		...
		if (expression != null && expression.eIsProxy()) {
			...
			if (expression != oldExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SchedulerPackage.RESET_SOLUTION_EXPRESSION_CANDIDATE_VALUE__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(SolutionExpression newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.RESET_SOLUTION_EXPRESSION_CANDIDATE_VALUE__EXPRESSION, oldExpression, expression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SchedulerPackage.RESET_SOLUTION_EXPRESSION_CANDIDATE_VALUE__EXPRESSION:
