...
public class TaskCandidateIntExpressionImpl extends CandidateIntExpressionImpl implements TaskCandidateIntExpression {
	...
	public SolutionTask getTask() {
		if (eContainerFeatureID() != SchedulerPackage.TASK_CANDIDATE_INT_EXPRESSION__TASK) return null;
	...
	public NotificationChain basicSetTask(SolutionTask newTask, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTask, SchedulerPackage.TASK_CANDIDATE_INT_EXPRESSION__TASK, msgs);
		return msgs;
	}
	...
	public void setTask(SolutionTask newTask) {
		if (newTask != eInternalContainer() || (eContainerFeatureID() != SchedulerPackage.TASK_CANDIDATE_INT_EXPRESSION__TASK && newTask != null)) {
