...
public class SolutionCandidateDateExpressionImpl extends CandidateDateExpressionImpl implements SolutionCandidateDateExpression {
	...
	public Solution getSolution() {
		if (eContainerFeatureID() != SchedulerPackage.SOLUTION_CANDIDATE_DATE_EXPRESSION__SOLUTION) return null;
	...
	public NotificationChain basicSetSolution(Solution newSolution, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSolution, SchedulerPackage.SOLUTION_CANDIDATE_DATE_EXPRESSION__SOLUTION, msgs);
		return msgs;
	}
	...
	public void setSolution(Solution newSolution) {
		if (newSolution != eInternalContainer() || (eContainerFeatureID() != SchedulerPackage.SOLUTION_CANDIDATE_DATE_EXPRESSION__SOLUTION && newSolution != null)) {
