 ...
 * </p>
 * <ul>
 *   <li>{@link com.misc.common.moplaf.scheduler.impl.ResourceExpressionImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link com.misc.common.moplaf.scheduler.impl.ResourceExpressionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ResourceExpressionImpl extends MinimalEObjectImpl.Container implements ResourceExpression {
	/**
	...
	protected EClass eStaticClass() {
		return SchedulerPackage.Literals.RESOURCE_EXPRESSION;
	}
	...
	public void setResource(SolutionResource newResource) {
		if (newResource != eInternalContainer() || (eContainerFeatureID() != SchedulerPackage.RESOURCE_EXPRESSION__RESOURCE && newResource != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SchedulerPackage.RESOURCE_EXPRESSION__RESOURCE, newResource, newResource));
	}
